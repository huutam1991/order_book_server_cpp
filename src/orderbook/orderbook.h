...
public:
    ...
    Task<void> get_mbp_msg_from_mbo_msg_async(Future<Json>::FutureValue* future_value, const databento::MboMsg& mbo_msg)
    {
    ...
    Future<Json> get_mbp_msg_from_mbo_msg(const databento::MboMsg& mbo_msg)
    {
        return Future<Json>([this, mbo_msg](Future<Json>::FutureValue* future_value)
        {
            auto task = this->get_mbp_msg_from_mbo_msg_async(future_value, mbo_msg);
            task.start_running_on(event_base);
        });
    }
